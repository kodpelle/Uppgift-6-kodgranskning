...
class Program
{
    ...
    {
        //instans av min listklass
        ListKlass listKlass = new ListKlass();
        //skriver ut oförändrad lista
        listKlass.PrintNames();

        //söker efter ett namn i listan, passar på att kolla om inbyggda metoden fungerar
        listKlass.SearchName("joHN");

        //lägger till ett namn i listan
        listKlass.AddToList();

        //skriver ut den sorterade listan
        listKlass.SortedNames();
